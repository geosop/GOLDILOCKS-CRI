...
\node[kern, fill=teal!8, draw=teal!60!black] (mem)
  {\textbf{[mem op]}\\[-1mm]\scriptsize [kernel integral]};
\node[kern, fill=blue!8, draw=blue!60!black, right=of mem, xshift=10mm] (sens)
  {\textbf{[sens op]}\\[-1mm]\scriptsize [note]};
...
\node[gatebox, above=of sens, yshift=12mm] (gate)
  {Goldilocks Gate\\[-0.5mm][gate formula]};
...
\begin{tikzpicture}
  \begin{axis}[width=3.6cm, height=2.4cm, xmin=0, xmax=1, ymin=0, ymax=1,
    ...
    axis lines=left, title style={font=\scriptsize}, title={\scriptsize [Gate title]}]
...
\begin{tikzpicture}
  \begin{axis}[width=3.6cm, height=2.4cm, xmin=0, xmax=1, ymin=0, ymax=1,
    ...
    title={\scriptsize [Decay title]}]
    \addplot [domain=0:1, samples=200] {exp(-x/0.25)};
  \end{axis}
\end{tikzpicture}
};
\node[tinycap, right=1mm of inset1] {[caption 1]};
\node[tinycap, right=1mm of inset2] {[caption 2]};
...
\node[kern, fill=magenta!10, draw=magenta!60!black, right=of collapse, xshift=6mm] (Lb)
  {\textbf{[Db block]}\\[-0.5mm]\scriptsize [single jump text]};
\node[kern, fill=blue!10, draw=blue!60!black, right=of Lb, xshift=6mm] (fwd)
  {\textbf{[fwd block]}\\[-0.5mm]\scriptsize [control text]};
