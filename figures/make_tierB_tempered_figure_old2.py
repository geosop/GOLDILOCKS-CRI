...
def main():
    ...
    fig.suptitle("Tier-B tempered mixtures: 1-exp vs 2-exp", fontsize=12, y=1.01)
    ...
    x_lab = max(0.004, bboxA.x0 - 0.012)     # a hair to the left of axA
    y_lab = min(0.996, bboxA.y1 + 0.008)     # a hair above axA
    fig.text(
        x_lab, y_lab, r'$(\mathit{c})$',
    ...
    for ext in ("png", "pdf"):
        fig.savefig(OUT_FIG / f"tierB_tempered_modelcomp.{ext}", bbox_inches="tight", dpi=300, pad_inches=0.01)
